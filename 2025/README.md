...
![](media/umbrella-tree-before.png)

I gave it a trim to try and fit it somewhere.

![](media/umbrella-tree-after.png)
...
![](media/backyard-before.png)

### Design

I designed an experimental idea to use in the backyard. 

![](media/backyard-design-idea.png)
...
![](media/backyard-design-executed.png)

### Planting

In the fall, I planted a ton of plants, more dwarf Japanese maples and bulbs for the spring.

![](media/backyard-planting.png)
![](media/backyard-planting-design.png)
